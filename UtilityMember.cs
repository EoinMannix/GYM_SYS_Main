...
using System.Windows.Forms; // needed for DataGridView 
using System.Drawing; // needed for DataGridViewContentAlignment
...
namespace GYM_SYS
{
    internal class UtilityMember
    {
        ...
        public static void FormatGrid(DataGridView dg)
        {
            ...
            dg.Columns["MEMBERID"].DefaultCellStyle.Format = "0000";
            dg.Columns["MEMBERID"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
